...
Public Class Report_EmptyIn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EmptyInMonitoring.Report_EmptyIn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_EmptyIn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_EmptyIn = New Report_EmptyIn()
        rpt.Site = Me.Site
        Return rpt
    End Function
